...
<div class="templatemo-content-container col-sm-11 col-md-offset-3">
		<div class="templatemo-site-header">
   			<h1 style="text-align: center; background-color: #176cb0; color: white;">Quản Lý Câu Hỏi</h1>
  		</div>
    ...
    @if(Session::has('flash_message'))
      ...
      @endif 
			<h3 style="color: black;">Danh sách câu hỏi</h3>
      <a href="them-san-pham" class="btn btn-info" >Thêm câu hỏi</a>
      <br>
      <br>
              ...
              <table class="table table-striped table-bordered templatemo-user-table dataTables">
                <thead>
                  <tr >
                      ...
                      <th style="background-color: #1b5ab6; color: white;">
                        <a style=" color: white; text-decoration: none;" href="" class="white-text templatemo-sort-by">Vòng Thi</a>
                      </th>
                ...
                <?php $pos=1; ?>
                 ...
                 @foreach($cauhoi as $cauhoi)
                    ...
                    <td>{!!$cauhoi->TG_CAUHOI!!}</td>
                    <td>{!!$cauhoi->STT_VONG!!}</td>
